        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="text-3xl font-bold text-green-800 mb-4">
              Join Our Network of Local Entrepreneurs
            </h2>
            <p className="text-lg text-gray-700 mb-6">
              Are you a local entrepreneur in Turrialba or Jiménez? Register
              your business and become part of our growing community.
            </p>
